view: accountspayable {
  ...
  measure: sum_overdue_amount_1_conv_drill  {
    ...
    link: {
      ...
      url: "/dashboards/cortex_sap_powermax::accounts_payable_aging?Target+Currency={{ _filters['currency_conversion_new.tcurr']| url_encode }}&Vendor+Name={{ _filters['accountspayable.name1']| url_encode }}&Company+Code={{ _filters['accountspayable.company_text_butxt']| url_encode }}"
    }
  }
